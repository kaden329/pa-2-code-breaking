...
**NAMES:** Kaden Robison and Zoe Kapp 
...
```{r}
#| label: Viewing my symbols vector
# making data frame
#Total observation 64
...
```{r}
#| label: Creating Code Break data frame
...
```{r}
#| label: Summarizing Code Break
#CHecking amount of observations above 17.
...
```{r}
#| label: Creating code break matrix
#Creating matrix in columns of 5
...
```{r}
#| label: Create even vector
#Sepereating even numbers between 1 and 382
...
```{r}
#| label: Subtracting code matrix
# Subtracting 100 from all the numbers in the 18-24th rows.
...
```{r}
#| label: Verifying numbers in Indices
...
```{r}
#| label: Square rooting indices
#Square rooting indices 38-465
...
```{r}
#| label: Reveal Secret Message
# Joining symbols by code and number.
code_vector_update |> 
